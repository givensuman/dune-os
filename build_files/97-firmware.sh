...
curl --retry 3 -Lo \
  /tmp/mediatek-firmware/WIFI_MT7922_patch_mcu_1_1_hdr.bin \
  https://gitlab.com/kernel-firmware/linux-firmware/-/raw/8f08053b2a7474e210b03dbc2b4ba59afbe98802/mediatek/WIFI_MT7922_patch_mcu_1_1_hdr.bin?inline=false
